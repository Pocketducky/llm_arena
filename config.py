...
DEFAULT_TEMPERATURE = _env_float("EMR_TEMPERATURE", 0.1)
# Верхняя граница длины ответа (vLLM: max_tokens; Ollama: num_predict). Имя
# DEFAULT_NUM_PREDICT сохранено ради обратной совместимости вызовов.
DEFAULT_NUM_PREDICT = _env_int("EMR_MAX_TOKENS", 1024)
